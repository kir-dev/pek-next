...
--
-- Name: svie_post_request; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.svie_post_request (
    id integer NOT NULL,
    member_type character varying,
    usr_id integer
);
...
--
-- Name: svie_post_request_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.svie_post_request_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: svie_post_request_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.svie_post_request_id_seq OWNED BY public.svie_post_request.id;
...
ALTER TABLE ONLY public.svie_post_request ALTER COLUMN id SET DEFAULT nextval('public.svie_post_request_id_seq'::regclass);
...
--
-- Name: svie_post_request_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.svie_post_request
    ADD CONSTRAINT svie_post_request_pkey PRIMARY KEY (id);

...
class GroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'show some group' do
    get "/groups/#{groups(:babhamozo).id}"
  ...
  test 'forbidden access to edit page' do
    get "/groups/#{groups(:babhamozo).id}/edit"

    assert_response :forbidden
  end

  test 'forbidden save after editing' do
    patch "/groups/#{groups(:babhamozo).id}"
  ...
  test 'save edited group' do
    ...
    patch "/groups/#{group.id}", group: { description: 'babot hámoznak' }
